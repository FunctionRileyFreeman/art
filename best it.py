...
def draw_sun():
    # Original sun
    pygame.draw.circle(screen, sun_color, (700, 100), 40)  # 20% smaller than original (50)

    # Second sun with opacity
    second_sun_surface = pygame.Surface((screen_width, screen_height), pygame.SRCALPHA)  # Create surface with alpha channel
    pygame.draw.circle(second_sun_surface, (255, 255, 0, 64), (700, 100), 50)  # 25% opacity
    screen.blit(second_sun_surface, (0, 0))  # Blit the second sun onto the screen

...
MAX_GENERATION_DEPTH = 8  # Maximum recursion depth
BRANCH_LENGTH = 20  # Length of each vine branch

# Create the screen
screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
pygame.display.set_caption("Procedural Vine Generator")
...
def generate_vine(x, y, angle, generation_depth):
    ...
    new_angle1 = angle + random.uniform(-math.pi / 6, math.pi / 6)
    new_angle2 = angle + random.uniform(-math.pi / 6, math.pi / 6)
